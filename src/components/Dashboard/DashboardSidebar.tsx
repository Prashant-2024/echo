...
const DashboardSidebar = () => {
  ...
  const othersMenuItems: MenuItem[] = [
    ...
    },
    {
      ...
      url: "mailto:devcodetest11@gmail.com",
      icon: Headphones,
    },
  ];
          ...
          <SidebarMenuItem>
            <OrganizationSwitcher
              ...
              appearance={{
                elements: {
                  rootBox:
                    "w-full! group-data-[collapsible=icon]:w-auto! group-data-[collapsible=icon]:flex! group-data-[collapsible]:justify-center!",
                  organizationSwitcherTrigger:
                    "w-full! justify-between! bg-white! border! border-border! rounded-md! pl-1! py-1! gap-3! group-data-[collapsible=icon]:w-auto! group-data-[collapsible]:p-1! shadow-[0px_1px_1.5px_0px_rgba(44,54,53,0.03)]!",
